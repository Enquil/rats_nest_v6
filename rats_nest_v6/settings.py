"""
Django settings for rats_nest_v6 project.
...
ROOT_URLCONF = 'rats_nest_v6.urls'
...
# Sets email backend for django, this only produces mails in console
